...
def Print_Histogram(field, f_histo = False):
    ...
    if f_histo:
        ...
        fig4, ax4 = HistoSnapshot(s,kappa)
        Snap_Save(fig4,tstep,mov_dir_histo)


def Print_3Dstrings(locs,axion,t_evol,tstep):

    fig5, ax5 = StringSnapshot(locs,t_evol,N)
    Snap_Save(fig5,tstep,mov_dir_3ds)
